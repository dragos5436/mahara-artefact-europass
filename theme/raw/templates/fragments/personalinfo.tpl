<div class="ptl pbl">
  <div class="card">
        ...
        <table border="0" id="personalinformation" class="resumeone fullwidth table">
            ...
            <tbody>
                <tr>
                    ...
                    <a class="btn btn-secondary" href="{$WWWROOT}artefact/europass/preferences.php?set=1&pn=21" title="{str tag='change'} {$order_str}"><span class="icon icon-exchange-alt icon-lg"></span></a>
                    {else}
                    <h3 class="pbs">{$profilefields.lastname} {$profilefields.firstname}</h3>
                    <a class="btn btn-secondary" href="{$WWWROOT}artefact/europass/preferences.php?set=1&pn=12" title="{str tag='change'} {$order_str}"><span class="icon icon-exchange-alt icon-lg"></span></a>
                    {/if}
                    </td>
                </tr>
                <tr>
                    ...
                    {if $profilefields.address}{$profilefields.address}{/if}{if $profilefields.town}, {$profilefields.town}{/if}{if $profilefields.city}, {$profilefields.city}{/if}{if $profilefields.countryname}, {str tag=$profilefields.countryname section='artefact.europass'}{/if}
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <div class="card-footer">
        <a class="btn btn-secondary" id="editprofilebutton" href="{$location.profile}" title="{str tag='edit'} {$profile_str}"><span class="icon icon-pencil-alt icon-lg prs"></span> {str tag='edit'} {$profile_str}</a>
        <a class="btn btn-secondary" id="editresumebutton" href="{$location.resume}" title="{str tag='edit'} {$resume_str}"><span class="icon icon-pencil-alt icon-lg prs"></span> {str tag='edit'} {$resume_str}</a>
    </div>
  </div>
</div>
