...
<div class="ptl pbl">
    <div class="card bg-info float-left" style="width:49%">
        <div class="card-body p-0">
        <table id="mothertongues" class="fullwidth table">
            <thead>
                <tr>
                    <th class="text-center text-white bg-info col-sm-6">{str tag='mothertongue' section='artefact.europass'}</th>
                </tr>
            </thead>
            <tbody>
                <tr>
    ...
    <div class="card bg-info float-right" style="width:49%">
        <div class="card-body p-0">
        <table id="otherlanguages" class="fullwidth table">
            <thead>
                <tr>
                    <th class="text-center text-white bg-info">{str tag='otherlanguage' section='artefact.europass'}</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>
                        ...
                        <div class="text-right card-footer has-form" style="background-color:transparent;border-top:1px solid transparent">
                            <a href="{$WWWROOT}artefact/europass/element/edit.php?type=otherlanguage" class="btn btn-secondary btn-sm" title="{str tag='add'}"><span class="icon icon-plus prs"></span> {str tag='add'}</a>
                        </div>
                    </td>
                </tr>
            </tbody>
...
<div id="otherlanguageslist">
{foreach from=$otherlanguages item=lang} 
    <div class="ptl pbl">
        <div class="card">
			<h3 class="card-header bg-secondary">{str tag='language.$lang->language' section='artefact.europass'}</h3>
            <div class="otherlanguage card-body p-0">
                <table border="0" class="resumeone fullwidth border-elp table">
                    ...
                    <tr>
                        ...
                        <div class="float-right">
                            <a href="{$WWWROOT}artefact/europass/element/edit.php?parent={$lang->artefact}&type=languagediploma" class="btn btn-secondary btn-sm" title="{str tag='add'}"><span class="icon icon-plus prs"></span> {str tag='add'}</a>
                        </div>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <div class="float-right">
                            <a href="{$WWWROOT}artefact/europass/element/edit.php?parent={$lang->artefact}&type=languageexperience" class="btn btn-secondary btn-sm" title="{str tag='add'}"><span class="icon icon-plus prs"></span> {str tag='add'}</a>
                        </div>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <div class="btn-group float-right">
                            ...
                            <a href="{$WWWROOT}artefact/europass/element/delete.php?id={$experience->artefact}" class="btn btn-secondary btn-sm" title="{str tag='delete'}"><span class="icon icon-trash-alt text-danger icon-lg"></span></a>
                        </div>
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-secondary" id="deletelanguage" href="{$WWWROOT}artefact/europass/element/delete.php?id={$lang->artefact}" title="{str tag='delete'}"><span class="icon icon-trash-alt text-danger icon-lg prs"></span> {str tag='delete'}</a>
            </div>
        </div>
    </div>
{/foreach}
